...
export default function BalanceSheetPage() {
  ...
  const assetItems = [
    ...
    { label: '  货币资金', amount: data.assets.current.cash },
    ...
    { label: '  固定资产', amount: data.assets.nonCurrent.fixedAsset },
    { label: '  累计折旧', amount: data.assets.nonCurrent.accumulatedDepreciation },
